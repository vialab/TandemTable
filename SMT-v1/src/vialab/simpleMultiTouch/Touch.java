...
public class Touch extends TuioCursor {
	...
	/**
	 * This constructor takes the attributes of the provided 
	 * TuioCursor and assigns these values to the newly created Touch.
	 * 
	 * @param t - TuioCursor
	 */
	...
	/**
	 * This constructor takes the provided Session ID, Cursor ID, X and Y coordinate and 
	 ...
	 * provided Session ID, Cursor ID, X and Y coordinate to the newly created Touch.
	 * 
