...
/**
 * Holds the information associated with a horizontal swipe event.<P>
 *
 ...
 * @version 1.0
 */
public class HSwipeEvent extends TuioEvent{
	 ...
	 * @param swipeType int - The direction of the swipe -> -1 for left swipe, 1 for right swipe
	 */
	public HSwipeEvent(int x, int y, long[] cursors, int swipeType) {
		super(x, y, cursors);
	 ...
	 * 
	 * @return swipeType, -1 for left swipe, 1 for right swipe
	 */
